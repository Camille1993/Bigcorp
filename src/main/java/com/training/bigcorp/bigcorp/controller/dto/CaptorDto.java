package com.training.bigcorp.bigcorp.controller.dto;
...
public class CaptorDto {
    ...
    public static Captor emptyCaptor(Site site, PowerSource powerSource) {
        Captor captor;
        switch (powerSource) {
            case REAL:
                captor = new RealCaptor();
                captor.setPowerSource(PowerSource.REAL);
                break;
            case FIXED:
                captor = new FixedCaptor();
                captor.setPowerSource(PowerSource.FIXED);
                break;
            case SIMULATED:
                captor = new SimulatedCaptor();
